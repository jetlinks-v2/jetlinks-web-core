...
export const USER_CENTER_MENU_DATA = {
  ...
  accessSupport: { value: 'support', label: '支持' },
  ...
  permissions: [
    ...
    {
      permission: 'smart-park-access-door-face',
      actions: ['issue', 'query', 'save', 'simple-delete', 'simple-update', 'delete', 'simple-add'],
    },
    {
      permission: 'smart-park-access-door-person',
      actions: ['query-face', 'query', 'save', 'delete', 'sync', 'query-picture-url'],
    },
  ],
  buttons: [
    {
