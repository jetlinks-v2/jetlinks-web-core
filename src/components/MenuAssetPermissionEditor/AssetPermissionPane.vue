    ...
    <header class="pane-header">
      ...
      <div class="batch-control">
        ...
        <a-select
          ...
          :disabled="!context.batchAssetOptions.value.length"
...
const { t: $t } = useI18n()
const props = defineProps<{ context: MenuAssetPermissionEditorContext }>()
...
.asset-name { margin-bottom: var(--space-3); color: var(--ink-1); font-weight: 600; }
