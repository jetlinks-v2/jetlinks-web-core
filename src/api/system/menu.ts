...
import { APPLICATION_SCOPE_HEADER } from '@jetlinks-web-core/utils/application-scope'
 ...
 * @returns
 */
export const getOwnMenuThree = (data: any, applicationScope?: string) => request.post(
  '/menu/user-own/tree',
  data,
  applicationScope
